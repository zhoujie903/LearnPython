...
def app_qu_tou_tiao():
    ...
    urls = [
        ...
        # 游戏 - 钓鱼
        Api(r'/xyx_sdk/gw/partner_login', log='游戏 - 钓鱼 - 登录'),            
...
def apps():
    ...
    urls.extend(api_common())
    qu_zhong_cai = App(urls, 'qu-zhong-cai')
    ...
    urls.extend(api_common())
    urls.extend(api_tczyqtt())
    you_xi_he_zi = App(urls, 'you-xi-he-zi')
    ...
    urls.extend(api_common())
    yang_ji_chang = App(urls, 'yang-ji-chang')
    ...
    urls.extend(api_common())
    tian_chi_xiao_xiu_cai = App(urls, 'tian-chi-xiao-xiu-cai')
    ...
    zhong_qin_kd = App(urls, 'zhong-qin-kd')
    ...
    cai_dan_sp = App(urls, 'cai-dan-sp')
    ...
    qu_jian_pan = App(urls, 'qu-jian-pan')
